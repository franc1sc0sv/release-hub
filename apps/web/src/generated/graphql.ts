...
export type CarriedOverFlagsQuery = { __typename?: 'Query', carriedOverFlags: Array<{ __typename?: 'CarriedOverFlagType', trackedFlagId: string, key: string, featureId: string | null, featureName: string | null, featureKind: FeatureKind | null, originReleaseId: string, originReleaseName: string, decision: ReleaseFlagDecisionType, deploymentStatus: FlagDeploymentStatus, decidedAt: string | null, decidedInThisRelease: boolean, featureReleaseState: FeatureState | null, addedInPullRequest: { __typename?: 'CarriedOverFlagPullRequestType', number: number, title: string, url: string | null } | null }> };
