...
export type CarriedOverFlagPullRequestType = {
  __typename?: 'CarriedOverFlagPullRequestType';
...
export type CarriedOverFlagType = {
  ...
  addedInPullRequest: Maybe<CarriedOverFlagPullRequestType>;
...
export type CloseTrackedFlagInput = {
...
export type DeleteFlagsInput = {
  flagKeys: Array<Scalars['String']['input']>;
  projectId: Scalars['ID']['input'];
};
...
export type FlagStateTargetInput = {
...
export type FlagWriteReportType = {
  __typename?: 'FlagWriteReportType';
  failed: Scalars['Int']['output'];
  results: Array<FlagWriteResultType>;
  succeeded: Scalars['Int']['output'];
};

export type FlagWriteResultType = {
  __typename?: 'FlagWriteResultType';
  environmentName: Maybe<Scalars['String']['output']>;
...
export type Mutation = {
  ...
  closeTrackedFlag: TrackedFlagClosureType;
  ...
  deleteFlags: FlagWriteReportType;
  ...
  reopenTrackedFlag: TrackedFlagClosureType;
  ...
  setFlagStates: FlagWriteReportType;
...
export type MutationCloseTrackedFlagArgs = {
  input: CloseTrackedFlagInput;
};
...
export type MutationDeleteFlagsArgs = {
...
export type MutationReopenTrackedFlagArgs = {
  key: Scalars['String']['input'];
  projectId: Scalars['ID']['input'];
};
...
export type MutationSetFlagStatesArgs = {
  input: SetFlagStatesInput;
};
...
export type Query = {
  ...
  me: UserProfileType;
  myInvitations: Array<ReceivedInvitationType>;
...
export type ReceivedInvitationType = {
  __typename?: 'ReceivedInvitationType';
  createdAt: Scalars['DateTime']['output'];
  expiresAt: Scalars['DateTime']['output'];
  id: Scalars['ID']['output'];
...
export type ReleaseFlagEnvironmentType = {
  __typename?: 'ReleaseFlagEnvironmentType';
  enabled: Scalars['Boolean']['output'];
  name: Scalars['String']['output'];
};
...
export type ReleaseFlagType = {
  ...
  environments: Array<ReleaseFlagEnvironmentType>;
  existsInFlagsmith: Scalars['Boolean']['output'];
...
export type ReleaseObjectType = {
  ...
  allowedNextStatuses: Array<ReleaseStatus>;
...
export type SetFlagStatesInput = {
  projectId: Scalars['ID']['input'];
  targets: Array<FlagStateTargetInput>;
};
...
export type TrackedFlagClosureType = {
  __typename?: 'TrackedFlagClosureType';
  closedAt: Maybe<Scalars['DateTime']['output']>;
  closedReason: Maybe<FlagClosedReason>;
  id: Scalars['ID']['output'];
  key: Scalars['String']['output'];
};
...
export type MyInvitationsQuery = { __typename?: 'Query', myInvitations: Array<{ __typename?: 'ReceivedInvitationType', id: string, token: string, organizationId: string, organizationName: string, inviterName: string, role: OrgRole, expiresAt: string, createdAt: string }> };
...
export type SetFlagStatesMutationVariables = Exact<{
  input: SetFlagStatesInput;
}>;


export type SetFlagStatesMutation = { __typename?: 'Mutation', setFlagStates: { __typename?: 'FlagWriteReportType', succeeded: number, failed: number, results: Array<{ __typename?: 'FlagWriteResultType', flagKey: string, environmentName: string | null, ok: boolean, error: string | null }> } };

export type DeleteFlagsMutationVariables = Exact<{
  input: DeleteFlagsInput;
}>;


export type DeleteFlagsMutation = { __typename?: 'Mutation', deleteFlags: { __typename?: 'FlagWriteReportType', succeeded: number, failed: number, results: Array<{ __typename?: 'FlagWriteResultType', flagKey: string, environmentName: string | null, ok: boolean, error: string | null }> } };

export type CloseTrackedFlagMutationVariables = Exact<{
  input: CloseTrackedFlagInput;
}>;


export type CloseTrackedFlagMutation = { __typename?: 'Mutation', closeTrackedFlag: { __typename?: 'TrackedFlagClosureType', id: string, key: string, closedAt: string | null, closedReason: FlagClosedReason | null } };

export type ReopenTrackedFlagMutationVariables = Exact<{
  projectId: Scalars['ID']['input'];
  key: Scalars['String']['input'];
}>;


export type ReopenTrackedFlagMutation = { __typename?: 'Mutation', reopenTrackedFlag: { __typename?: 'TrackedFlagClosureType', id: string, key: string, closedAt: string | null, closedReason: FlagClosedReason | null } };
...
export type CarriedOverFlagsQuery = { __typename?: 'Query', carriedOverFlags: Array<{ __typename?: 'CarriedOverFlagType', trackedFlagId: string, key: string, featureId: string | null, featureName: string | null, featureKind: FeatureKind | null, featureDescription: string | null, originReleaseId: string, originReleaseName: string, decision: ReleaseFlagDecisionType, deploymentStatus: FlagDeploymentStatus, decidedAt: string | null, decidedInThisRelease: boolean, featureReleaseState: FeatureState | null, addedInPullRequest: { __typename?: 'CarriedOverFlagPullRequestType', number: number, title: string, summary: string | null, url: string | null } | null }> };
...
export type ReleaseFlagsQuery = { __typename?: 'Query', releaseFlags: Array<{ __typename?: 'ReleaseFlagType', id: string, key: string, decision: ReleaseFlagDecisionType | null, decidedAt: string | null, existsInFlagsmith: boolean, closedAt: string | null, environments: Array<{ __typename?: 'ReleaseFlagEnvironmentType', name: string, enabled: boolean }>, feature: { __typename?: 'TrackedFlagFeatureType', id: string, name: string } | null, changes: Array<{ __typename?: 'ReleaseFlagChangeType', kind: FlagReferenceKind, action: FlagChangeAction, detectedFile: string | null, prNumber: number, prTitle: string, prUrl: string }> }> };
...
export const SetFlagStatesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SetFlagStates"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SetFlagStatesInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"setFlagStates"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"succeeded"}},{"kind":"Field","name":{"kind":"Name","value":"failed"}},{"kind":"Field","name":{"kind":"Name","value":"results"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"flagKey"}},{"kind":"Field","name":{"kind":"Name","value":"environmentName"}},{"kind":"Field","name":{"kind":"Name","value":"ok"}},{"kind":"Field","name":{"kind":"Name","value":"error"}}]}}]}}]}}]} as unknown as DocumentNode<SetFlagStatesMutation, SetFlagStatesMutationVariables>;
export const DeleteFlagsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteFlags"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DeleteFlagsInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteFlags"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"succeeded"}},{"kind":"Field","name":{"kind":"Name","value":"failed"}},{"kind":"Field","name":{"kind":"Name","value":"results"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"flagKey"}},{"kind":"Field","name":{"kind":"Name","value":"environmentName"}},{"kind":"Field","name":{"kind":"Name","value":"ok"}},{"kind":"Field","name":{"kind":"Name","value":"error"}}]}}]}}]}}]} as unknown as DocumentNode<DeleteFlagsMutation, DeleteFlagsMutationVariables>;
export const CloseTrackedFlagDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CloseTrackedFlag"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CloseTrackedFlagInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"closeTrackedFlag"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"closedAt"}},{"kind":"Field","name":{"kind":"Name","value":"closedReason"}}]}}]}}]} as unknown as DocumentNode<CloseTrackedFlagMutation, CloseTrackedFlagMutationVariables>;
export const ReopenTrackedFlagDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ReopenTrackedFlag"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"projectId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"key"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"reopenTrackedFlag"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"projectId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"projectId"}}},{"kind":"Argument","name":{"kind":"Name","value":"key"},"value":{"kind":"Variable","name":{"kind":"Name","value":"key"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"closedAt"}},{"kind":"Field","name":{"kind":"Name","value":"closedReason"}}]}}]}}]} as unknown as DocumentNode<ReopenTrackedFlagMutation, ReopenTrackedFlagMutationVariables>;
