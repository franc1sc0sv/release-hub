...
export type CarriedOverFlagsQuery = { __typename?: 'Query', carriedOverFlags: Array<{ __typename?: 'CarriedOverFlagType', trackedFlagId: string, key: string, featureId: string | null, featureName: string | null, originReleaseId: string, originReleaseName: string, decision: ReleaseFlagDecisionType, deploymentStatus: FlagDeploymentStatus, decidedAt: string | null, featureReleaseState: FeatureState | null }> };
