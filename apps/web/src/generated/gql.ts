...
const documents: Documents = {
    ...
    "\n  mutation SetFlagStates($input: SetFlagStatesInput!) {\n    setFlagStates(input: $input) {\n      succeeded\n      failed\n      results {\n        flagKey\n        environmentName\n        ok\n        error\n      }\n    }\n  }\n": types.SetFlagStatesDocument,
    "\n  mutation DeleteFlags($input: DeleteFlagsInput!) {\n    deleteFlags(input: $input) {\n      succeeded\n      failed\n      results {\n        flagKey\n        environmentName\n        ok\n        error\n      }\n    }\n  }\n": types.DeleteFlagsDocument,
    "\n  mutation CloseTrackedFlag($input: CloseTrackedFlagInput!) {\n    closeTrackedFlag(input: $input) {\n      id\n      key\n      closedAt\n      closedReason\n    }\n  }\n": types.CloseTrackedFlagDocument,
    "\n  mutation ReopenTrackedFlag($projectId: ID!, $key: String!) {\n    reopenTrackedFlag(projectId: $projectId, key: $key) {\n      id\n      key\n      closedAt\n      closedReason\n    }\n  }\n": types.ReopenTrackedFlagDocument,
    ...
    "\n  query CarriedOverFlags($releaseId: ID!) {\n    carriedOverFlags(releaseId: $releaseId) {\n      trackedFlagId\n      key\n      featureId\n      featureName\n      originReleaseId\n      originReleaseName\n      decision\n      deploymentStatus\n      decidedAt\n      decidedInThisRelease\n      featureReleaseState\n    }\n  }\n": types.CarriedOverFlagsDocument,
